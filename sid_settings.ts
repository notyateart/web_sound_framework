...
settingsMaster.Slider = document.getElementById('volSliderMaster') as HTMLInputElement;
settingsMaster.SliderValue = document.getElementById('volSliderMasterValue') as HTMLElement;
settingsMaster.Mute = document.getElementById('volMuteMaster') as HTMLInputElement;

var settingsDefault = new SettingsGroup();
settingsDefault.Slider = document.getElementById('volSliderDefault') as HTMLInputElement;
settingsDefault.SliderValue = document.getElementById('volSliderDefaultValue') as HTMLElement;
settingsDefault.Mute = document.getElementById('volMuteDefault') as HTMLInputElement;

var settingsImportant = new SettingsGroup();
settingsImportant.Slider = document.getElementById('volSliderImportant') as HTMLInputElement;
settingsImportant.SliderValue = document.getElementById('volSliderImportantValue') as HTMLElement;
settingsImportant.Mute = document.getElementById('volMuteImportant') as HTMLInputElement;

var settingsHover = new SettingsGroup();
settingsHover.Slider = document.getElementById('volSliderHover') as HTMLInputElement;
settingsHover.SliderValue = document.getElementById('volSliderHoverValue') as HTMLElement;
settingsHover.Mute = document.getElementById('volMuteHover') as HTMLInputElement;

var settingsHold = new SettingsGroup();
settingsHold.Slider = document.getElementById('volSliderHold') as HTMLInputElement;
settingsHold.SliderValue = document.getElementById('volSliderHoldValue') as HTMLElement;
settingsHold.Mute = document.getElementById('volMuteHold') as HTMLInputElement;

if (!!settingsMaster.Mute) settingsMaster.Mute.checked = volMaster.Muted;
if (!!settingsDefault.Mute) settingsDefault.Mute.checked = volDefault.Muted;
if (!!settingsImportant.Mute) settingsImportant.Mute.checked = volImportant.Muted;
if (!!settingsHover.Mute) settingsHover.Mute.checked = volHover.Muted;
if (!!settingsHold.Mute) settingsHold.Mute.checked = volHold.Muted;
